<template>
  <div class="home">
    <h1>Welcome to Fred</h1>
    <p>Sometimes we all need a helping hand to stay motivated with our goals.</p><br>
    <p> In the spirt of our favorite 'good neighbor' - Fred is here to help you connect with a stranger to stay motivated.</p>
